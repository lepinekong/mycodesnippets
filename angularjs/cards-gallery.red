Red [
    Title: "cards-gallery.red"
]

Article: [

    Title: {angularjs cards gallery}

    Source: [
        .title: {ReAdABLE Source [(What is the ReAdABLE Human Format?)](http://readablehumanformat.com)}
        .text: {[http://mycodesnippets.space/angularjs/cards-gallery.red](https://github.com/lepinekong/mycodesnippets/blob/master/angularjs/cards-gallery.red)
        }
        .Published-Url: http://mycodesnippets.space/angularjs/cards-gallery
    ]  
