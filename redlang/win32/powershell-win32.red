...
Article: [
    ...
    Title: {powershell win32}

    Source: [
        .title: {ReAdABLE Source [(What is the ReAdABLE Human Format?)](http://readablehumanformat.com)}
        .text: {[http://mycodesnippets.space/redlang/win32/powershell-win32.red](https://github.com/lepinekong/mycodesnippets/blob/master/redlang/win32/powershell-win32.red)
        }
        .Published-Url: http://mycodesnippets.space/redlang/win32/powershell-win32
    ]  
    ...
    demo: [
        ...
        .quote: {do read https://miniapps.red/jotnote}
    ...
    code-snippet: [
        ...
        .title: {Code Snippet}
        .image: https://i.imgur.com/PsCzf9z.png
        .links: [
