Red [
    Title: "powershell.installer.generator.red"
]

Article: [

    Title: {powershell.installer.generator}

    Source: [
        .title: {ReAdABLE Source [(What is the ReAdABLE Human Format?)](http://readablehumanformat.com)}
        .text: {[http://mycodesnippets.space/redlang/powershell.installer.generator.red](https://github.com/lepinekong/mycodesnippets/blob/master/redlang/powershell.installer.generator.red)
        }
        .Published-Url: http://mycodesnippets.space/redlang/powershell.installer.generator
    ]    
