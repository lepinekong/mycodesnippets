...
Article: [
    ...
    Source: [
        ...
        .text: {[http://mycodesnippets.space/html/star-rating.red](https://github.com/lepinekong/mycodesnippets/blob/master/html/star-rating.red)
        }
        .Published-Url: http://mycodesnippets.space/html/star-rating
    ]    
