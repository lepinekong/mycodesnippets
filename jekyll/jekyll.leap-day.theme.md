...
To automate this update, you can use this _config.red script:
...
To make header clickable to return to home and have no-cache, put this code in _layout\default.html:
